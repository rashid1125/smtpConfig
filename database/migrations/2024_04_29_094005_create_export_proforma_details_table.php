...
class CreateExportProformaDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('export_proforma_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('export_proforma_id')->unsigned()->nullable();
            ...
            $table->foreign('export_proforma_id')->references('id')->on('export_proformas')->onUpdate('CASCADE')->onDelete('CASCADE');
    ...
    {
        Schema::dropIfExists('export_proforma_details');
    }
}
