...
class CreateExportQuotationDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('export_quotation_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('export_quotation_id')->unsigned()->nullable();
    ...
    {
        Schema::dropIfExists('export_quotation_details');
    }
}
