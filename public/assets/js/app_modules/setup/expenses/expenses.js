var Expenses = function () {
	...
	var getMaxId = function () {
		...
		$.ajax({
			...
			url: base_url + 'index.php/expense/getMaxId',
			type: 'POST',
			dataType: 'JSON',
	...
	var save = function (accountObj) {
		general.disableSave();
		$.ajax({
			url: base_url + 'index.php/expense/save',
			type: 'POST',
			...
			success: function (data) {
				...
				if (data.error === 'false') {
					...
					$.notify({ message: 'Expense name already used...!!!' }, { type: 'success' });
				} else {
					$.notify({ message: 'Expense saved successfully...!!!' }, { type: 'success' });
	...
	var fetch = function (spid) {
		...
		$.ajax({
			url: base_url + 'index.php/expense/fetchAccount',
			type: 'POST',
			data: { 'spid': spid },
			dataType: 'JSON',
			success: function (data) {
	...
	return {
		...
		bindModalPartyGrid: function () {
			...
			Expenses.pdTable = $('#party-lookup table').dataTable({
