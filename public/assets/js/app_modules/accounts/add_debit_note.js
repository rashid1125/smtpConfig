...
const DebitNoteVoucher = function () {
    ...
    const chk_date = $('#debit_note_chk_date');
    ...
    var fetch = function (debitNoteId) {
        $.ajax({
            url: `${base_url}/debitNote/fetch`,
            type: 'GET',
    ...
    var populateData = async function (data) {
        ...
        $.each(data.debit_note_details, function (index, elem) {
    ...
    var resetVoucher = function () {
        resetFields();
        getDebitNoteDataTable();
        $('#voucher_type_hidden').val('new');
    };

    var resetFields = function () {
        $('#debitNoteIdHidden').val('');
    ...
    const getDebitNoteDataTable = (debitNoteId = 0, fromDate = "", toDate = "") => {
        ...
        purchaseOrderViewList = $("#purchaseOrderViewList").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `${base_url}/debitNote/getDebitNoteDataTable`,
                type: 'GET',
                data: { 'debitNoteId': debitNoteId, fromDate: fromDate, toDate: toDate },
            ...
            columns: [
                ...
                {
                    data: "vrnoa",
                    name: "debit_notes.vrnoa",
                    className: "text-left debitNoteVoucher"
                },
                {
                    data: "vrdate",
                    name: "debit_notes.vrdate",
                ...
                { data: "remarks", name: 'debit_notes.remarks', className: "remarks" },
                {
                    data: null,
                    ...
                    render: function (data, type, row) {
						...
						<button type  = "button" class = "btn btn-sm btn-outline-secondary dropdown-toggle" data-toggle = "dropdown" aria-haspopup = "true" aria-expanded = "false">
							...
							<div class = "dropdown-menu">
							<a   class = "dropdown-item btnEditPrevVoucher" data-debit_note_id = "${row.id}" href = "#"><i class = 'fa fa-edit'></i> Edit Voucher</a>
							<a   class = "dropdown-item btnPrint"  data-debit_note_id          = "${row.id}" href = "#"><i class = 'fa fa-print'></i> Print Voucher</a>
							<a   class = "dropdown-item btnDelete" data-debit_note_id          = "${row.id}" href = "#"><i class = 'fa fa-trash'></i> Delete Voucher</a>
							<div class = "dropdown-divider"></div>
							<a   class = "dropdown-item btnPrintASEmail" data-debit_note_id    = "${row.id}" href = "#">Send Email</a>
							</div>
						</div>
    ...
    return {
        ...
        bindUI: function () {
            ...
            $('#purchaseOrderFilter').on('click', function (e) {
                ...
                getDebitNoteDataTable("", fromDate, toDate);
            });
            ...
            $('body').on('click', '.btnPrint', function (e) {
                const debitNoteId = $(this).data('debit_note_id');
                ...
                if ($('#setting_print_default').val() == 5 || $('#setting_print_default').val() == 6) {
                    ...
                    Print_Voucher(debitNoteId, settingPrintDefault, 'lg', '');
                }
            });

            $('body').on('click', '.btnEditPrevVoucher', function (e) {
                e.preventDefault();
                const debitNoteId = parseNumber($(this).data('debit_note_id'));
                fetch(debitNoteId);
            ...
            $('body').on('click', '.btnPrintASEmail', function (e) {
                ...
                const settingPrintDefault = $('#setting_print_default').val();
                e.preventDefault();
                getSendMail(debitNoteId, settingPrintDefault, 'lg', '', true);
            });
...
var debitNoteVoucher = new DebitNoteVoucher();
debitNoteVoucher.init();
