    ...
    e = function() {
        ...
        e.prototype.add_option = function(e, t, n) {
            if (e.nodeName.toUpperCase() === "OPTION")
                return e.text !== "" ? (t != null && (this.parsed[t].children += 1),
                this.parsed.push({
...
function() {
    ...
    t = function(t) {
        ...
        i.prototype.container_mousedown = function(t) {
            var n;
            if (!this.is_disabled)
                return n = t != null ? e(t.target).hasClass("search-choice-close") : !1,
                t && t.type === "mousedown" && !this.results_showing && t.preventDefault(),
                !this.pending_destroy_click && !n ? (this.active_field ? !this.is_multiple && t && (e(t.target)[0] === this.selected_item[0] || e(t.target).parents("a.chzn-single").length) && (t.preventDefault(),
        ...
        i.prototype.results_build = function() {
            ...
            i = s.length; n < i; n++)
                t = s[n],
                t.group ? e += this.result_add_group(t) : t.empty || (e += this.result_add_option(t),
        ...
        i.prototype.set_tab_index = function(e) {
            ...
            if (this.form_field_jq.attr("tabindex"))
                return t = this.form_field_jq.attr("tabindex"),
        ...
        i.prototype.choice_build = function(t) {
            ...
            !1) : (n = this.container_id + "_c_" + t.array_index,
            this.choices += 1,
        ...
        i.prototype.choice_destroy_link_click = function(t) {
            ...
            this.is_disabled ? t.stopPropagation : (this.pending_destroy_click = !0,
        ...
        i.prototype.result_select = function(e) {
            ...
            if (this.result_highlight)
                ...
                this.is_multiple ? this.choice_build(r) : (this.selected_item.find("span").first().text(r.text),
                this.allow_single_deselect && this.single_deselect_control_build()),
        ...
        i.prototype.result_deselect = function(t) {
            ...
            this.form_field.options[r.options_index].disabled ? !1 : (r.selected = !1,
            ...
            m = y.length; d < m; d++) {
                ...
                if (!n.disabled && !n.empty)
                    if (n.group)
                        ...
                        h = h.substr(0, c) + "<em>" + h.substr(c)) : h = n.html,
                        u.html(h),
        ...
        i.prototype.keyup_arrow = function() {
            ...
            if (!this.results_showing && !this.is_multiple)
                return this.results_show();
            if (this.result_highlight)
                return e = this.result_highlight.prevAll("li.active-result"),
        ...
        i.prototype.keydown_backstroke = function() {
            ...
            if (e.length && !e.hasClass("search-choice-disabled"))
                return this.pending_backstroke = e,
