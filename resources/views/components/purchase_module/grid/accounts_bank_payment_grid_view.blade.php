        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-responsive text-md" id="bank_payment_table">
                        <thead class="cf tbl_thead py-2 px-2">
                            <tr class="py-2 px-2 text-md">
                                ...
                                <th class="py-2 px-2 text-md align-middle text-left">Invoice #</th>
                                <th class="py-2 px-2 text-md align-middle text-left">Cheque Date</th>
                                <th class="py-2 px-2 text-md align-middle text-left">Cheque #</th>
