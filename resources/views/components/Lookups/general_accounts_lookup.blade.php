<script>
    var dataCallFromAddNewGeneralAccounts = @json($dataCallFromAddNewGeneralAccounts);
</script>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const getGeneralAccountsListViewRecord = () => {
            ...
            searchItemListViewTable = $("#ExpenseViewList").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: base_url + '/account/generalaccount/getGeneralAccountsListViewRecord',
                    data: function(data) {
                        data.params = {
                            sac: "",
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<button type="button" class="btn btn-sm btn-outline-primary group-hover:bg-blue-600 group-hover:border-blue-600 group-hover:text-white align-right mr-1 mb-1 flex-1 btn-edit-generalaccounts ${dataCallFromAddNewGeneralAccounts}" data-pid="${data.pid}"> <i class='fa fa-edit'></i> </button>`;
                        }
                    }
                ]
            });
        }
        getGeneralAccountsListViewRecord();
    });
</script>